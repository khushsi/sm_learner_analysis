...
if __name__ == '__main__':
    ...
    interaction_folds = int_data.studentwise_interaction__activity_folds(no_of_folds=no_of_folds,
    ...
    for concept_list_name in concept_dictionary:
        ...
        # pfa_mod = LFA_R(concept_obj.concept_list, int_data.studentList, name="lfa_" + concept_obj.conceptlistname,is_reading_behaviour=False)
        # pfa_mod.setFolds(int_folds, int_con_attempts)
        # pfa_mod.fitFolds()
        # pfa_mod.predictFolds()
        # pfa_mod.printResult()
        # # pfa_mod.fitAIC()
        #
        # pfa_mod = LFA_R(concept_obj.concept_list, int_data.studentList, name="lfa_r_" + concept_obj.conceptlistname,is_reading_behaviour=True)
        # pfa_mod.setFolds(int_folds, int_con_attempts)
        # pfa_mod.fitFolds()
        # pfa_mod.predictFolds()
        # pfa_mod.printResult()
